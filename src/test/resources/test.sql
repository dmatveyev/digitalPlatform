-- Пользователи
INSERT INTO USERS (ID, LOGIN, PASSWORD, ENABLED, TOKEN_EXPIRED) VALUES ('4c1e8ca4-c820-43c9-97e2-186edf346523', 'teacher', null, true, false);
INSERT INTO USERS (ID, LOGIN, PASSWORD, ENABLED, TOKEN_EXPIRED) VALUES ('aa25d9af-f18b-4bf1-bef6-f70176b89b52', 'user', '{bcrypt}$2a$10$AsgwBmSDITYg8KEkQWfPXeiTy9mcJRPHY1esw2bHyrmPny8PCZhIy', true, false);
-- Роли
INSERT INTO ROLES (ID, NAME) VALUES ('fba1ffbb-5e6c-4abf-8d1d-aff59ca895b9', 'ROLE_ADMIN');
INSERT INTO ROLES (ID, NAME) VALUES ('e15f209c-6398-4647-9c8d-d3101349e198', 'ROLE_USER');
--Привилегии
INSERT INTO PRIVILEGES (ID, NAME) VALUES ('10fad87d-ac18-44ac-a75b-38d0fb1e6351', 'READ_PRIVILEGE');
INSERT INTO PRIVILEGES (ID, NAME) VALUES ('54f7f41e-e83d-4f40-b719-e5d400d0566f', 'WRITE_PRIVILEGE');
--Привилегии ролей
INSERT INTO ROLES_PRIVILEGES (PRIVILEGE_ID, ROLE_ID) VALUES ('10fad87d-ac18-44ac-a75b-38d0fb1e6351', 'fba1ffbb-5e6c-4abf-8d1d-aff59ca895b9');
INSERT INTO ROLES_PRIVILEGES (PRIVILEGE_ID, ROLE_ID) VALUES ('54f7f41e-e83d-4f40-b719-e5d400d0566f', 'fba1ffbb-5e6c-4abf-8d1d-aff59ca895b9');
INSERT INTO ROLES_PRIVILEGES (PRIVILEGE_ID, ROLE_ID) VALUES ('10fad87d-ac18-44ac-a75b-38d0fb1e6351', 'e15f209c-6398-4647-9c8d-d3101349e198');
--Назначения
INSERT INTO USERS_ROLES (ROLE_ID, USER_ID) VALUES ('fba1ffbb-5e6c-4abf-8d1d-aff59ca895b9', 'aa25d9af-f18b-4bf1-bef6-f70176b89b52');
-- Заказчики
