...
-- Параметры рейтинга
insert into PUBLIC.rating_parameters (id, code, description, min_value, max_value, coefficient) values ('dc1e8ca4-c820-43c9-97e2-186edf346521', 'AVERAGE_SCORE', 'Подсчет по среднему баллу автора запроса', 1.0, 5.0, 0.4);
insert into PUBLIC.rating_parameters (id, code, description, min_value, max_value, coefficient) values ('dc1e8ca4-c820-43c9-97e2-186edf346522', 'PERIODICAL_WORK', 'Подсчет по периодичности занятий', 1.0, 10.0, 0.1);
insert into PUBLIC.rating_parameters (id, code, description, min_value, max_value, coefficient) values ('dc1e8ca4-c820-43c9-97e2-186edf346523', 'TYPE_ORGANIZATION', 'Подсчет по типу учреждения автора запроса', 1.0, 10.0, 0.3);
insert into PUBLIC.rating_parameters (id, code, description, min_value, max_value, coefficient) values ('dc1e8ca4-c820-43c9-97e2-186edf346524', 'AUTHOR_PREVIOUS_REQUESTS', 'Подсчет на основе предыдущих запросов автора', 1.0, 10.0, 0.7);
insert into PUBLIC.rating_parameters (id, code, description, min_value, max_value, coefficient) values ('dc1e8ca4-c820-43c9-97e2-186edf346525', 'DEADLINE', 'Подсчет по близости срока исполнения', 1.0, 10.0, 0.5);
